...
tournament$tourney_finish <- factor(tournament$tourney_finish, levels = c('1st', '2nd','RSF', 'RF', 'NSF', 'N2nd', 'Champ' ))
...
ggplot(tournament, aes(x=tourney_finish, y=reg_percent, color=seed)) + 
  ...
  scale_x_discrete(labels=c("1st" = "1st Round", "2nd" = "2nd Round", 'RSF'='Sweet 16', 'RF'='Elite Eight', 'NSF'='Final Four', 'N2nd'='Final (2nd Place)', 'Champ'='National Champion')) +
  theme_bw() + 
